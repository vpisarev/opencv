...
static SplitFunc getSplitFunc(int depth)
{
    static SplitFunc splitTab[] =
    {
        ...
        (SplitFunc)GET_OPTIMIZED(cv::hal::split32s), (SplitFunc)GET_OPTIMIZED(cv::hal::split32s), (SplitFunc)GET_OPTIMIZED(cv::hal::split64s),
        (SplitFunc)GET_OPTIMIZED(cv::hal::split16u), 
    };
